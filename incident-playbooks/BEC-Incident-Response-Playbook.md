...
| **Impossible Travel Detection** | Flags anomalous sign-ins from distant geographies within short time intervals. | [impossible-travel.kql](evidence/kql/impossible-travel.kql) |
